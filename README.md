...
1. **Clone the repository**
   ```bash
   git clone [https://github.com/lakshya215/Agentic-C-Code-Interpreter-Execution-Sandbox.git](https://github.com/lakshya215/Agentic-C-Code-Interpreter-Execution-Sandbox.git)
